...
TEMPLATE_DIR=${TEMPLATE_DIR:-/home/centos/worker}
...
sudo yum install -y \
    ...
    unzip \
    wget
sudo yum localinstall -y $TEMPLATE_DIR/aws-cfn-bootstrap-1.4-31.noarch.rpm
...
S3_URL_BASE="https://$BINARY_BUCKET_NAME.s3.amazonaws.com/$BINARY_BUCKET_PATH"
...
sudo dos2unix /etc/systemd/system/kubelet.service
